...
import 'Pharmacist_approval_view_model.dart';
import 'View_sheets_view_model.dart';
class pharmacist_approval_view extends StatefulWidget {
  Warehouselist? data;
  pharmacist_approval_view({ this.data});
  @override
  State<pharmacist_approval_view> createState() => _Create_new_sheetState();
}

class _Create_new_sheetState extends State<pharmacist_approval_view> {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<Pharmacist_view_model>.reactive(
      ...
      viewModelBuilder: () => Pharmacist_view_model(),
